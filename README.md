...
class Solution {
    public int trap(int[] height) {
        ...
        while(right>left){
            ...
            //or if(leftMax<rightMax)
            //if(height[left]<height[right])
            //trap water in block i = min(leftMax,rightMax)- height[i]
            //So if(leftMax<rightMax), to height[left],the water trap here is defined, left++ to skip this point.
            if(leftMax<rightMax){
